...
export const createStartCommand: CommandItem<
  any,
...
> = async (app) => ({
  ...
  builder: {
    ...
    restart: {
      ...
      alias: 'r',
      describe:
        'Retart app(only pm2),pm2 will auto run start if process not exists.',
      default: false,
    },
    typescript: {
      type: 'boolean',
    ...
    debug: {
      ...
      alias: 'd',
      describe:
        'Whether to enable debug mode, only valid for non-production environments',
      default: false,
    },
  },
